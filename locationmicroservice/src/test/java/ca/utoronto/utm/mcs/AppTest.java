...
public class AppTest {
    ...
    public void getNearbyDriverPass() throws JSONException, IOException, InterruptedException {
        ...
        HttpRequest r = HttpRequest.
                newBuilder().
                uri(URI.create("http://localhost:8004/location/nearbyDriver/ilir?radius=2")).build();
    ...
    public void getNearbyDriverFail() throws JSONException, IOException, InterruptedException {
        ...
        HttpRequest r = HttpRequest.
                newBuilder().
                uri(URI.create("http://localhost:8004/location/nearbyDriver/john?radius=-1")).build();
        HttpResponse<String> res = c.send(r, HttpResponse.BodyHandlers.ofString());
    ...
    public void getNavigationPass() throws JSONException, IOException, InterruptedException {
        ...
        HttpRequest r = HttpRequest.
                newBuilder().
                uri(URI.create("http://localhost:8004/location/navigation/john?passengerUid=ilir")).build();
        HttpResponse<String> res = c.send(r, HttpResponse.BodyHandlers.ofString());
    ...
    public void getNavigationFail() throws JSONException, IOException, InterruptedException {
        ...
        HttpRequest r = HttpRequest.
                newBuilder().
                uri(URI.create("http://localhost:8004/location/navigation/john?passengerUid=ilir12")).build();
        HttpResponse<String> res = c.send(r, HttpResponse.BodyHandlers.ofString());
